...
const CREDIT_DATA = [		// refer to dev_data/credits.txt
    ">People (PLEASE NOTE THIS IS A PARODY)",
	"",
	"",
	"Gautam Babbar",
	"Ted Backman",
	...
	"Quintin Doroquez",
	"Jim Dose",
	"Douglas Fir Dancing Christmas Tree",
	"Laura Dubuk",
	"Mike Dunkle",
	"Mike Durand",
	"Mike Dussault",
	...
	"Shawn Zabecki",
	"Dexcom, Omipod, Libre, ",
	" and t:slim copyrighted by rightfun owners",
	"",
	"",
	"",
 	"'Still High' by:",
	...
	"",
 	"Website: SDSkyKlouD",
	"OG song: Jonathan Coulton ",
	"IMAGES:",
	"Dexcom logo: Dexcom G7",
	"t:slim logo: Tandem",
	"Skull: Apple",
	"High Alert: Dexcom G6",
	"Sugar: Domino Sugar",
	"Water Drop: Clipart",
	"Reese's Pieces Logo: Hershey's",
	"Libre logo: Abbott Laboratories",
	"Insulin Needle: I forgot",
	"Lightbulb: Unused Ascii art",
	"Kovu (The Lion King 2: Simba's Pride): Disney",
	"",
	"",
	"",
